...
//    }
    public EditPaddockWindow(WebDialog owner) throws HeadlessException {
...
//        });
        addRation.addActionListener((ActionEvent e) -> {
            AddRationWindow addRation1 = new AddRationWindow(EditPaddockWindow.this);
            addRation1.setSize(350, 200);
            addRation1.setResizable(false);
            addRation1.setLocationRelativeTo(null);
            addRation1.setVisible(true);
        });
