...
public class EditAnimalWindow extends WebDialog {
...
//    }
    ...
    public EditAnimalWindow(WebFrame owner) throws HeadlessException {
        super(owner,"Редактирование животного",ModalityType.APPLICATION_MODAL);
        contentPane = getContentPane();
        setLayout(new GridBagLayout());
        initEditAnimal();
    }
    
    private void initEditAnimal(){
...
//        WebButton addAndGo = new WebButton("Добавить и перейти к животному");
        ...
        vaccinationsButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                TableOfVaccinationsWindow tableOfVaccinations = new TableOfVaccinationsWindow(EditAnimalWindow.this);
